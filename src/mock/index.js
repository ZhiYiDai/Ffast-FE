...
createMock(user, false)        // 管理员管理
createMock(role, false)        // 角色管理
createMock(menu, false)        // 菜单管理
createMock(log, false)         // 系统日志
createMock(config, false)      // 参数管理
createMock(oss, false)         // 文件服务
createMock(schedule, false)    // 定时任务
